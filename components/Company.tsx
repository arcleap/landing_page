...
export function Company() {
  return (
    <section id="company" className="scroll-mt-24 border-t border-rule">
      <div className="container-page grid grid-cols-1 gap-12 py-24 md:py-36 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8 lg:col-start-5">
          ...
          <p className="mt-8 max-w-[58ch] text-xl leading-8 text-ink-dim">
            {company.body}
          </p>
          <div className="mt-16 flex items-end justify-between gap-8 border-t border-rule pt-8">
            ...
            <div aria-hidden className="h-px w-24 bg-accent/60 md:w-48" />
          </div>
        </div>
      </div>
    </section>
